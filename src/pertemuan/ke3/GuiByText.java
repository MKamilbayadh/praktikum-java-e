...
public class GuiByText extends JFrame{
    ...
    GuiByText(){
        setSize(640,480);//ukuran default
        setLocationRelativeTo(null);//Lokasi
        setTitle("Gui By Text");//Judul
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);//Saat klik close akan keluar form
    }
    void letakkanKomponen()
    {
        ...
        btnHitung.setBounds(16,146,200,25);
